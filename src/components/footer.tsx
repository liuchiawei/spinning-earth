export default function Footer({ name }: { name: string }) {
  return (
    <footer className="text-center bg-linear-to-b from-cyan-500 dark:from-cyan-700 to-blue-800 text-white py-12 flex flex-col justify-center items-center gap-6">
